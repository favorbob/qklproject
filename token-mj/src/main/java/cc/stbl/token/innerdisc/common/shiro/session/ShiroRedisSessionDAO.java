...
//        int expire = 1800;
        ...
        this.redisManager.set(key, value, Long.valueOf(timeout / 1000).intValue());
        logger.info("shiro_redis_dao_saveSession_{}_use_time={}",session.getId(),System.currentTimeMillis() - c);
    }
