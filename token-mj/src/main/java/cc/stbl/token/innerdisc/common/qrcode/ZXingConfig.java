...
public class ZXingConfig {
	...
	private int width = 298; // 生成图片宽度
	private int height = 298; // 生成图片高度
	...
	private int qRCode = new Color(50,73,171,1).getRGB();//二维码颜色
	private int qRCodeBgd = new Color(255,255,255,1).getRGB();//二维码背景
	...
	public int getQRCodeBgd() {
		return qRCodeBgd;
	}

	public void setQrCodeBgd(int qrCodeBgd) {
		this.qRCodeBgd = qrCodeBgd;
	}
}
